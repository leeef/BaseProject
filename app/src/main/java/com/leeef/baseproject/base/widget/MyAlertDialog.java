package com.leeef.baseproject.base.widget;
...
public class MyAlertDialog extends AlertDialog {
  ...
  protected MyAlertDialog(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
    ...
    view = inflater.inflate(R.layout.base_popup_dialog, null);
    initView();
  }
   ...
   */
  public static MyAlertDialog create(Context context, String title, String message, String confirm, View.OnClickListener
    ...
    MyAlertDialog dialog = new MyAlertDialog(context, cancelable, canceledOnTouchOutside);
   ...
   * @return MyAlertDialog
   */
  public static MyAlertDialog create(Context context, int titleRes, int messageRes, int confirmRes, View.OnClickListener
